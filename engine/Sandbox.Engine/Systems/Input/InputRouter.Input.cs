...
internal static partial class InputRouter
{
	...
	internal static void OnMouseButton( ButtonCode button, bool down, int ikeymods )
	{
		...
		if ( mouse is null )
		{
			mouse = GameWantsCapture
				? IGameInstanceDll.Current?.InputContext
	...
	internal static void OnMouseMotion( float dx, float dy )
	{
...
#if !WIN
		// Linux: Filter out synthetic motion events generated by our own cursor warp.
		...
		if ( mouse is null && GameWantsCapture )
		{
